...
TR-069 parameter name-value pair

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**name** | **str** | Parameter name (TR-069 path) | 
**value** | [**ParameterValueValue**](ParameterValueValue.md) |  | 
**type** | **str** | Parameter data type | [optional] 
